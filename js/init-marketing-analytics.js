(function(){var targetedContentJson=loadInlineJSON("marketingTargetedContent");
var data=loadInlineJSON("marketingAnalyticsEnvironment");
var environment=data["environment"];
try{var analyticsConfig={environment:environment,customerData:{organizationId:"aws-signin"}};
...
}catch(e){}try{(function(){if(typeof window.CustomEvent==="function"){return false;
...
var response={"contents":{},"errors":[]};
if(!(targetedContentJson&&typeof targetedContentJson==="object")){throw"Content is malformed";
}response["contents"]=targetedContentJson;
var eventDetail={detail:response};
